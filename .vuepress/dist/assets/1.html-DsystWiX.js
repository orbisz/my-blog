...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="抽象工厂模式" tabindex="-1"><a class="header-anchor" href="#抽象工厂模式"><span>抽象工厂模式</span></a></h3><p><img src="`+h+'" alt=""> 围绕一个超级工厂创建其他的工厂，提供了一种创建对象的最佳方式。</p><p><strong>案例</strong></p><p>替换Redis双集群升级，代理类抽象场景。 <img src="'+b+`" alt=""></p><p>工程结构：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">itstack-demo-design-2-02</span>
<span class="line">└── src</span>
<span class="line">├── main</span>
<span class="line">│   └── java</span>
<span class="line">│       └── org.itstack.demo.design</span>
...
<span class="line">└── org.itstack.demo.design.test</span>
<span class="line">└── ApiTest.java</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+g+'" alt=""><code>ICacheAdapter</code>，定义了适配接口，分别包装两个集群中差异化的接口名称。<code>EGMCacheAdapter</code>、<code>IIRCacheAdapter</code><code>JDKProxy</code>、<code>JDKInvocationHandler</code>，是代理类的定义和实现，这部分也就是抽象工厂的另外一种实现方式。通过这样的方式可以很好的把原有操作Redis的方法进行代理操作，通过控制不同的入参对象，控制缓存的使用。</p><h2 id="结构型模式" tabindex="-1"><a class="header-anchor" href="#结构型模式"><span>结构型模式!</span></a></h2><h3 id="组合模式" tabindex="-1"><a class="header-anchor" href="#组合模式"><span>组合模式</span></a></h3><p><img src="'+j+`" alt=""> 也称为整体-部分模式，宗旨是通过将单个对象（叶子节点）和组合对象（树枝节点）用相同的接口进行表示，使得客户对单个对象和组合对象的使用具有一致性。</p><p><strong>案例</strong></p><p>营销差异化人群发券，决策树引擎搭建场景</p><p>工程结构：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">itstack-demo-design-8-02</span>
<span class="line">└── src</span>
<span class="line">├── main</span>
<span class="line">│   └── java</span>
...
<span class="line">└── org.itstack.demo.design.test</span>
<span class="line">└── ApiTest.java</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+x+'" alt="img.png"> 首先可以看下黑色框框的模拟指导树结构；1、11、12、111、112、121、122，这是一组树结构的ID，并由节点串联组合出一棵关系树。</p><p>接下来是类图部分，左侧是从LogicFilter开始定义适配的决策过滤器，BaseLogic是对接口的实现，提供最基本的通用方法。UserAgeFilter、UserGenerFilter，是两个具体的实现类用于判断年龄和性别。</p><p>最后则是对这颗可以被组织出来的决策树，进行执行的引擎。同样定义了引擎接口和基础的配置，在配置里面设定了需要的模式决策节点。</p><h2 id="行为型模式" tabindex="-1"><a class="header-anchor" href="#行为型模式"><span>行为型模式</span></a></h2><h3 id="责任链模式" tabindex="-1"><a class="header-anchor" href="#责任链模式"><span>责任链模式</span></a></h3><p><img src="'+k+`" alt=""> 为了避免请求发送者与多个请求处理者耦合在一起，于是将所有的请求处理者连成一条链，通过前一个对象记住其下一个对象的引用；当有引用发生时，可以将请求沿着这条链传递，直到有对象处理它。</p><p><strong>案例</strong></p><p>618大促上线多级审批：开始-&gt;三级-&gt;二级-&gt;一级-&gt;结束</p><p>工程架构：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">itstack-demo-design-13-02</span>
<span class="line">└── src</span>
<span class="line">    └── main</span>
<span class="line">        └── java</span>
<span class="line">            └── org.itstack.demo.design</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>策略模式架构 <img src="`+_+`" alt=""></p><h3 id="模板模式" tabindex="-1"><a class="header-anchor" href="#模板模式"><span>模板模式</span></a></h3><p>定义一个操作中的算法骨架，而将算法的一些步骤延迟到子类中，使得子类可以不改变该算法结构的情况下重定义该算法的某些特定步骤。 就像西游记的99八十一难，基本每一关都是；师傅被掳走、打妖怪、妖怪被收走，具体什么妖怪你自己定义，怎么打你想办法，最后收走还是弄死看你本事，我只定义执行顺序和基本策略，具体的每一难由观音来安排。 核心点在于由抽象类定义抽象方法执行策略，也就是说父类规定好了一系列的执行标准，这些标准串联成一整套业务流程。 <strong>案例</strong></p><p>模拟爬虫各类电商商品，生成营销推广海报场景。步骤：模拟登录、爬取信息、生成海报。</p><p>工程结构</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">itstack-demo-design-21-00</span>
<span class="line">└── src</span>
<span class="line">    ├── main</span>
<span class="line">    │   └── java</span>
<span class="line">    │       └── org.itstack.demo.design</span>
...
<span class="line">            └── org.itstack.demo.design.test</span>
<span class="line">                └── ApiTest.java</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>模板模式模型结构 <img src="`+C+'" alt=""> 一个定义了抽象方法执行顺序的核心抽象类，以及三个模拟具体的实现(京东、淘宝、当当)的电商服务。</p><h3 id="参考文献" tabindex="-1"><a class="header-anchor" href="#参考文献"><span>参考文献</span></a></h3>',75)),n("p",null,[n("a",y,[s[0]||(s[0]=d("小傅哥 bugstack 虫洞栈")),p(a)])]),s[2]||(s[2]=n("p",null,"https://refactoringguru.cn/design-patterns/factory-method",-1))])}const T=e(D,[["render",I]]),N=JSON.parse('{"path":"/blogs/backend/DesignPatterns/1.html","title":"Java 设计模式-学习总结","lang":"en-US","frontmatter":{"title":"Java 设计模式-学习总结","date":"2025/04/02","tags":["设计模式"],"categories":["后端学习"]},"headers":[{"level":3,"title":"替代if...else的三种设计模式","slug":"替代if-else的三种设计模式","link":"#替代if-else的三种设计模式","children":[]},{"level":3,"title":"六大设计原则","slug":"六大设计原则","link":"#六大设计原则","children":[]},{"level":2,"title":"创建者模式","slug":"创建者模式","link":"#创建者模式","children":[{"level":3,"title":"工厂方法模式","slug":"工厂方法模式","link":"#工厂方法模式","children":[]},{"level":3,"title":"抽象工厂模式","slug":"抽象工厂模式","link":"#抽象工厂模式","children":[]}]},{"level":2,"title":"结构型模式!","slug":"结构型模式","link":"#结构型模式","children":[{"level":3,"title":"组合模式","slug":"组合模式","link":"#组合模式","children":[]}]},{"level":2,"title":"行为型模式","slug":"行为型模式","link":"#行为型模式","children":[{"level":3,"title":"责任链模式","slug":"责任链模式","link":"#责任链模式","children":[]},{"level":3,"title":"策略模式","slug":"策略模式","link":"#策略模式","children":[]},{"level":3,"title":"模板模式","slug":"模板模式","link":"#模板模式","children":[]},{"level":3,"title":"参考文献","slug":"参考文献","link":"#参考文献","children":[]}]}],"git":{"createdTime":1751505378000,"updatedTime":1751505378000,"contributors":[{"name":"zxy","email":"zxy0613zxy@outlook.com","commits":1}]},"filePathRelative":"blogs/backend/DesignPatterns/1.md"}');export{T as comp,N as data};
