import{_ as a,c as t,a as r,b as s,d as i,e as l,r as d,o as p}from"./app-B4AT7fMT.js";const c={},m={href:"https://leetcode.cn/problems/search-insert-position/description/?envType=study-plan-v2&envId=top-100-liked",target:"_blank",rel:"noopener noreferrer"},v={href:"https://leetcode.cn/problems/search-in-rotated-sorted-array/?envType=study-plan-v2&envId=top-100-liked",target:"_blank",rel:"noopener noreferrer"},o={href:"https://leetcode.cn/problems/find-minimum-in-rotated-sorted-array/?envType=study-plan-v2&envId=top-100-liked",target:"_blank",rel:"noopener noreferrer"};function u(b,n){const e=d("ExternalLinkIcon");return p(),t("div",null,[n[3]||(n[3]=r(`<p>二分查找法（Binary Search）是一种高效的搜索算法，其核心思想是将搜索范围每次缩小一半，从而显著降低时间复杂度。</p><p><strong>基本原理</strong></p><p>要求数据结构已排序（如升序数组）。</p><ul><li><strong>确定搜索区间</strong>：初始时覆盖整个数组。</li><li>计算中间点：取区间中间位置的元素。</li><li><strong>比较中间元素</strong>： <ul><li>若中间元素等于目标值，返回位置。</li><li>若中间元素大于目标值，说明目标在左半区间，更新右边界。</li><li>若中间元素小于目标值，说明目标在右半区间，更新左边界。</li></ul></li><li>重复步骤 2-3，直到找到目标值或区间为空。</li></ul><p><strong>复杂度</strong></p><p>时间复杂度：<code>O(logn)</code></p><p><strong>代码模板</strong> 查找目标值</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">int binarySearch(int[] nums, int target) {</span>
